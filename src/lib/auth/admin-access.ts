...
export const ADMIN_NAV: AdminNavItem[] = [
  ...
  { href: "/admin/shop-styles", label: "Shop styles", permissions: ["catalog.write"] },
  { href: "/admin/reviews", label: "Reviews", permissions: ["catalog.write"] },
  ...
  { href: "/admin/settings", label: "Settings", permissions: ["settings.read", "catalog.write"] },
];
...
export const ADMIN_ROUTE_PERMISSIONS: Record<string, readonly string[]> = {
  ...
  "/admin/shop-styles": ["catalog.write"],
  ...
  "/admin/settings": ["settings.read", "catalog.write"],
};

...
export default async function ConfirmationPage({
  ...
  return (
    <div className="mx-auto max-w-lg text-center">
      ...
      <h1 className="mt-2 font-display text-3xl text-navy">{order.orderNumber}</h1>
      <p className="mt-4 text-muted">
        Thank you for your order. We will contact you to confirm delivery details.
      </p>
      <p className="mt-6 text-2xl font-semibold tabular-nums text-navy">{formatMoney(order.totalMinor)}</p>

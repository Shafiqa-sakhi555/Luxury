-- Run this in Supabase Dashboard → SQL Editor if npm run supabase:migrate is not configured.
-- Combines migrations 015 + 016 for category size options.
...
-- optional size toggle per category
